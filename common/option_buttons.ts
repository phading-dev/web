    ...
    this.body = E.div(
      {
        ...
        style: `flex: 0 0 auto; font-size: ${FONT_M}rem; font-weight: ${FONT_WEIGHT_600}; line-height: ${LINE_HEIGHT_FOR_BUTTON_M}rem; border-radius: ${LINE_HEIGHT_FOR_BUTTON_M}rem; padding: 0 ${GAP_0_75X}rem; border: ${BORDER_WIDTH_2}rem solid; ${customStyle}`,
      },
      E.text(label),
    );
    this.enable();
    ...
    this.body = E.div(
      {
        ...
        style: `flex: 0 0 auto; display: flex; justify-content: center; font-size: ${FONT_M}rem; font-weight: ${FONT_WEIGHT_600}; line-height: ${LINE_HEIGHT_M}rem; padding: ${GAP_0_5X}rem ${GAP_0_75X}rem; cursor: pointer; border-bottom: ${BORDER_WIDTH_2}rem solid; ${customStyle}`,
      },
      E.text(label),
    );
