...
export function createBrandIcon(size: number): HTMLDivElement {
  return E.div(
    {
      style: `align-self: center; display: flex; flex-flow: row nowrap; align-items: center; height: ${size}rem; font-size: ${size}rem; line-height: 1; color: ${SCHEME.neutral0};`,
    },
    E.text("SEC"),
...
export function createLogoIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "logo-icon",
      style: `height: 100%; fill: none; stroke: ${color};`,
      viewBox: "-2 -2.8 24 24",
    },
    // 50 deg to 10 deg
    E.path({
...
export function createCircleWithArrowIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "replay-icon",
      style: `height: 100%; fill: ${color};`,
...
export function createMoneyBagIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "coin-icon",
      style: `height: 100%; fill: ${color};`,
...
export function createCheckedBoxIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "box-icon",
      style: `height: 100%; fill: ${color};`,
...
export function createPriceTagIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "price-tag-icon",
      style: `height: 100%; fill: ${color};`,
      viewBox: ".75 2.75 13.5 13.5",
    },
    E.path({
...
export function createCircleIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "circle-icon",
      style: `height: 100%; fill: none; stroke: ${color}; stroke-width: 4; stroke-linecap: round; stroke-linejoin: round;`,
    ...
    E.path({
      d: `M10 0 A10 10 0 1 1 9.9 0z`,
    }),
  );
}

export function createDotInACircleIcon(color: string): SVGSVGElement {
  return E.svg(
    {
      class: "dot-in-a-circle-icon",
      style: `height: 100%; fill: none; stroke: ${color}; stroke-width: 4; stroke-linecap: round; stroke-linejoin: round;`,
      viewBox: "-2 -2 24 24",
    },
    E.path({
      d: `M10 0 A10 10 0 1 1 9.9 0z M10 8 A2 2 0 1 1 9.9 8z`,
    }),
  );
}
