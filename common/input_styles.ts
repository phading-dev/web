...
export let COMMON_BASIC_INPUT_STYLE = `${NULLIFIED_INPUT_STYLE} font-size: ${FONT_M}rem; line-height: ${LINE_HEIGHT_XXL}rem; color: ${SCHEME.neutral0}; color-scheme: ${SCHEME.name}; border-bottom: .1rem solid;`;
// Needs border-color.
