...
import { FONT_M, FONT_WEIGHT_600, LINE_HEIGHT_XXL } from "./sizes";
...
export let COMMON_BUTTON_STYLE = `${NULLIFIED_BUTTON_STYLE} flex: 0 0 auto; font-size: ${FONT_M}rem; font-weight: ${FONT_WEIGHT_600}; line-height: ${LINE_HEIGHT_XXL}rem; padding: 0 1.2rem; border: .1rem solid transparent; border-radius: ${BUTTON_BORDER_RADIUS}; cursor: pointer;`;
