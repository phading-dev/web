...
export let COMMON_BUTTON_STYLE = `${NULLIFIED_BUTTON_STYLE} flex: 0 0 auto; font-size: ${FONT_M}rem; line-height: 100%; padding: .8rem 1.2rem; border: .1rem solid transparent; border-radius: ${BUTTON_BORDER_RADIUS}; cursor: pointer;`;
