...
export class RecommendationPage extends EventEmitter {
  public static create(state: RecommendationPageState): RecommendationPage {
    return new RecommendationPage(
      PRODUCT_RECOMMENDATION_SERVICE_CLIENT,
      SeasonItem.create,
    ...
    this.body = E.div(
      ...
      E.div(
        ...
        E.divRef(this.contentContainer, {
          ...
          style: `width: 100%; display: grid; grid-template-columns: repeat(auto-fill, minmax(24.2rem, 1fr)); gap: .1rem;`,
        }),
        E.divRef(
          this.loadingSection,
          {
  ...
  public async loadMoreAndTryRemoveOldContent(): Promise<void> {
    let response = await recommendSeasons(this.webServiceClient, {
