...
export class PlayPage extends EventEmitter {
  ...
  private startPlaying(): void {
    ...
    this.heartBeatLoopId = this.window.setTimeout(this.heartBeatRecurringly);
  ...
  private heartBeatRecurringly = (): void => {
    ...
    this.heartBeatLoopId = this.window.setTimeout(
  ...
  private stopPlaying(): void {
    ...
    this.window.clearTimeout(this.heartBeatLoopId);
  }
