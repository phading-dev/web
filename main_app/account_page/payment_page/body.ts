      ...
      E.div(
        {
          ...
          style: `display: flex; flex-flow: row nowrap; gap: ${GAP_0_5X}rem; align-items: center;`,
        },
        E.div(
          {
            ...
            E.div(
              {
                ...
                style: `width: 100%; display: flex; flex-flow: row-reverse wrap; gap: ${GAP_0_5X}rem; align-items: center; justify-content: flex-start;`,
              },
              assign(
