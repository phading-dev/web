  ...
  cases: [
    new (class implements TestCase {
      ...
      public async execute() {
        ...
        // Execute
        this.cut.lines[0].click();
        this.cut.lines[1].click();

        // Verify
        await asyncAssertScreenshot(
          path.join(__dirname, "/usage_page_phone_default_expanded.png"),
          path.join(__dirname, "/golden/usage_page_phone_default_expanded.png"),
          path.join(__dirname, "/usage_page_phone_default_expanded_diff.png"),
        );
    ...
    new (class implements TestCase {
      ...
      public async execute() {
        ...
        // Prepare
        this.cut.lines[0].click();
        this.cut.lines[5].click();

        // Verify
        await asyncAssertScreenshot(
          path.join(__dirname, "/usage_page_desktop_day_range_expanded.png"),
          path.join(
            __dirname,
            "/golden/usage_page_desktop_day_range_expanded.png",
          ),
          path.join(
            __dirname,
            "/usage_page_desktop_day_range_expanded_diff.png",
          ),
        );
    ...
    new (class implements TestCase {
      ...
      public async execute() {
        ...
        // Execute
        this.cut.lines[0].click();
        this.cut.lines[3].click();

        // Verify
        await asyncAssertScreenshot(
          path.join(__dirname, "/usage_page_desktop_month_range_expanded.png"),
          path.join(
            __dirname,
            "/golden/usage_page_desktop_month_range_expanded.png",
          ),
          path.join(
            __dirname,
            "/usage_page_desktop_month_range_expanded_diff.png",
          ),
        );
