...
TEST_RUNNER.run({
  ...
  cases: [
    new (class implements TestCase {
      ...
      private cut: PublisherShowroomPage;
      public async execute() {
        ...
        let serviceClientMock = new (class extends WebServiceClientMock {
          public async send(
            ...
            switch (request.descriptor) {
              ...
              case LIST_SEASONS_BY_RECENT_PREMIERE_TIME_AND_PUBLISHER:
        ...
        await asyncAssertScreenshot(
          path.join(__dirname, "/search_seasons_page_render.png"),
          path.join(__dirname, "/golden/search_seasons_page_render.png"),
          path.join(__dirname, "/search_seasons_page_render_diff.png"),
        );
        ...
        await asyncAssertScreenshot(
          path.join(__dirname, "/search_seasons_page_scrolled.png"),
          path.join(__dirname, "/golden/search_seasons_page_scrolled.png"),
          path.join(__dirname, "/search_seasons_page_scrolled_diff.png"),
        );
