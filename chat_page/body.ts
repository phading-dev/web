...
export interface ChatPage {
  on(event: "newState", listener: (newState: ChatPageState) => void): this;
}

export class ChatPage extends EventEmitter {
  private state: ChatPageState;
  private pendingNewState: ChatPageState;
  ...
  public updateState(newState?: ChatPageState): void {
    if (!newState) {
      newState = {};
    }
  ...
  private async normalizeState(newState: ChatPageState): Promise<void> {
